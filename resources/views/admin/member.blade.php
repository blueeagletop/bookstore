...
<div class="pd-20">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
          ...
          @endif</td>
					<td class="td-manage">
						<a title="编辑" href="javascript:;" onclick="member_edit('编辑类别','member_edit?id={{$member->id}}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
						{{-- <a title="删除" href="javascript:;" onclick='category_del("{{$member->username}}", "{{$member->id}}")' class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a> --}}
					</td>
				</tr>
			@endforeach
