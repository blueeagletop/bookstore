...
<form action="" method="post" class="form form-horizontal" id="form-category-edit">
  ...
  <div class="row cl">
    ...
    <div class="formControls col-5">
      <input type="number" class="input-text" value="{{$category->category_com}}" placeholder="" name="category_com"  datatype="*" nullmsg="序号不能为空">
    </div>
    <div class="col-4"> </div>
  </div>
  <div class="row cl">
  ...
  $("#form-category-edit").Validform({
    ...
    callback:function(form){
      ...
      $('#form-category-edit').ajaxSubmit({
          ...
          url: 'service/category/edit', // 需要提交的 url
          dataType: 'json',
          data: {
            id: "{{$category->id}}",
