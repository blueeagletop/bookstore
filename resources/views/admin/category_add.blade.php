...
<form action="" method="post" class="form form-horizontal" id="form-category-add">
  ...
  <div class="row cl">
    ...
    <div class="formControls col-5">
      <input type="number" class="input-text" value="0" placeholder="" name="category_com"  datatype="*" nullmsg="序号不能为空">
    </div>
    <div class="col-4"> </div>
  </div>
  <div class="row cl">
  ...
  $("#form-category-add").Validform({
    ...
    callback:function(form){
      ...
      $('#form-category-add').ajaxSubmit({
          ...
          url: 'service/category/add', // 需要提交的 url
          dataType: 'json',
          data: {
            name: $('input[name=name]').val(),
            category_com: $('input[name=category_com]').val(),
